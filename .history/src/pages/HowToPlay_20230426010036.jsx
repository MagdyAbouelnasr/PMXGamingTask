            ...
            <table className="table-auto border-spacing-x-5 border-spacing-y-2 border border-slate-300">
              ...
              <tbody>
                ...
                <tr className="border border-slate-300">
                  ...
                  <td className="border border-slate-300 p-3">+30 hbar</td>
                  <td className="border border-slate-300 p-3">+3000 hbar</td>
                  <td className="border border-slate-300 p-3">+0.3 sol</td>
                  <td className="border border-slate-300 p-3">+12 sol</td>
                </tr>
                <tr className="border border-slate-300">
